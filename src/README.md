<!-- Generated from the repository README. Do not edit here.
     Source: README.md at the repo root. Regenerate before publishing. -->

<p align="center">
  <img src="https://raw.githubusercontent.com/snoels/privacy.md/main/assets/banner.svg" alt="privacy.md — AGENTS.md tells an agent how to work. privacy.md tells it what it may send." width="100%">
</p>
...
|---|---|---|
| Claude Code | [`adapters/claude-code.js`](https://github.com/snoels/privacy.md/blob/main/src/adapters/claude-code.js) | `PreToolUse` hook |
| OpenAI Agents SDK | [`adapters/openai-agents.js`](https://github.com/snoels/privacy.md/blob/main/src/adapters/openai-agents.js) | `guard()` per tool |

[`portability.test.js`](https://github.com/snoels/privacy.md/blob/main/src/test/portability.test.js) drives each adapter the way
...
| | |
|---|---|
| [BRIEF.md](https://github.com/snoels/privacy.md/blob/main/BRIEF.md) | The full design: thesis, outcomes, rule taxonomy, evidence, open calls |
| [SLIDES.md](https://github.com/snoels/privacy.md/blob/main/SLIDES.md) | The pitch, four slides |
| [src/ARCHITECTURE.md](https://github.com/snoels/privacy.md/blob/main/src/ARCHITECTURE.md) | Architecture and build order |
| [CONTRIBUTING.md](https://github.com/snoels/privacy.md/blob/main/CONTRIBUTING.md) | How to edit the docs, and how a doc change becomes a build change |

## Contributing

Docs are edited in the browser, no terminal required. Build changes arrive as
issues, never as a silent edit. See [CONTRIBUTING.md](https://github.com/snoels/privacy.md/blob/main/CONTRIBUTING.md).

## License

MIT. See [LICENSE](https://github.com/snoels/privacy.md/blob/main/LICENSE).
